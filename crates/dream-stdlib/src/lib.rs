...
pub const STD_PACKAGES: &[StdPackage] = &[
    ...
    StdPackage {
        ...
        files: &[
            ...
            (
                "<std>/system/gpu/gpu_sampler_desc.dream",
                include_str!("system/gpu/gpu_sampler_desc.dream"),
            ),
            (
            ...
            (
                "<std>/system/gpu/gpu_texture_desc.dream",
                include_str!("system/gpu/gpu_texture_desc.dream"),
            ),
            (
            ...
            (
                "<std>/system/gpu/gpu_query_set.dream",
                include_str!("system/gpu/gpu_query_set.dream"),
            ),
            (
                "<std>/system/gpu/gpu_surface_desc.dream",
                include_str!("system/gpu/gpu_surface_desc.dream"),
            ),
            (
