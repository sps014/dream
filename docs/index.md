...
- **Types checked** before you run
- **No manual memory**
- **Runs in the browser** (and on your machine)
- **Lists, files, HTTP, JSON, GPU, crypto** in the stdlib
- **Talk to JavaScript** when you need the DOM
- **Talk to C** on the native host
- **async / WebWorkers** for concurrency
