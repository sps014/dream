...
4. [Collections](../reference/stdlib/collections.md) — `List`, `Map`, `Set`
5. [Cookbook](../cookbook/index.md) — lists, GPU, source generators
6. [Package manager](../reference/tooling/dreamer.md) — `dreamer add` and registries
