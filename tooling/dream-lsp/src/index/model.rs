...
/// `static async Task.spawn<TOut>(body: fun(): TOut): TOut` → `["TOut"]`.
...
/// `static Task.spawn(body: fun(): TOut): TOut`.
...
/// `detail` looks like `async TaskPool.dispatch<TOut>(body: fun(): TOut): TOut`;
